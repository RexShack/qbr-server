# PolyZone
PolyZone is originally a FiveM mod to define zones of different shapes and test whether a point is inside or outside of the zone, this version allows you to use it with RedM
